...
constexpr uint32_t SEEL_TRANSMISSION_UB_DUR_MILLIS = 50;
...
constexpr uint32_t SEEL_TDMA_BUFFER_MILLIS = 50; // Buffer time between scheduled TMDA transmissions, factors in receive buffer copy delay (SEEL_Print'ed in RFM receive method)
