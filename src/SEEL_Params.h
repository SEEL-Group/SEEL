...
constexpr uint32_t SEEL_MSG_USER_SIZE = 60;
constexpr uint8_t SEEL_EXTENDED_PACKET_MAX_NODES_EXPECTED = 10;
...
constexpr uint32_t SEEL_TRANSMISSION_UB_DUR_MILLIS = 1000;
